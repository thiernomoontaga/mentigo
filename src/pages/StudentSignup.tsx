...
const steps = [
  ...
  { id: 4, title: 'Matières', icon: Target },
  { id: 5, title: 'Disponibilités', icon: Calendar },
...
const subjects = [
  ...
  'Anglais', 'Arabe', 'Espagnol', 'Histoire', 'Géographie',
  'Économie', 'Philosophie', 'SVT', 'Cuisine Africaine', 'Culture Africaine'
];

const levels = [
  'Primaire', 'Collège', 'Lycée', 'Université', 'Prépa', 'Professionnel', 'Adulte débutant'
];
      ...
      case 1:
        return (
          <div className="text-center space-y-6 flex-1 flex flex-col justify-center">
            ...
            <h2 className="text-2xl font-bold">Commencez votre voyage éducatif</h2>
            <p className="text-muted-foreground max-w-md mx-auto">
              Rejoignez des milliers d'étudiants africains qui ont trouvé leur voie vers la réussite grâce à Mentigo
            </p>
          </div>
        );
      case 2:
        return (
          <div className="space-y-6 flex-1">
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground">Renseignez vos coordonnées</p>
            </div>
        ...
        return (
          <div className="space-y-6 flex-1">
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground">Sélectionnez votre niveau actuel</p>
            </div>
            ...
            <div className="space-y-4 flex-1">
              <div className="space-y-2 flex-1">
                ...
                <Textarea
                  ...
                  placeholder="Ex: Préparer un examen, améliorer mon niveau en anglais, apprendre les bases de la programmation, découvrir la culture africaine..."
                  rows={8}
          ...
          <div className="flex flex-col justify-center items-center p-12 w-full">
            ...
            >
              <img
                ...
                alt="Étudiant africain souriant"
